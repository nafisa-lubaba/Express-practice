  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        ...
        "ShorthandInitialiser": parse_ShorthandInitialiser,
        "ShorthandInitialiserNoIn": parse_ShorthandInitialiserNoIn,
        "ShorthandVariableDeclaration": parse_ShorthandVariableDeclaration,
        "ShorthandVariableDeclarationList": parse_ShorthandVariableDeclarationList,
        "ShorthandVariableDeclarationListNoIn": parse_ShorthandVariableDeclarationListNoIn,
        "ShorthandVariableDeclarationNoIn": parse_ShorthandVariableDeclarationNoIn,
        ...
        "VariableExpression": parse_VariableExpression,
        "VariableStatement": parse_VariableStatement,
        "VariableStatementNoIn": parse_VariableStatementNoIn,
      ...
      function parse_MemberExpression() {
        ...
        var savedPos0 = pos;
        var savedPos1 = pos;
        var result46 = parse_PrimaryExpression();
        if (result46 !== null) {
          var result3 = result46;
        } else {
          var result45 = parse_FunctionExpression();
          if (result45 !== null) {
            var result3 = result45;
          } else {
            var savedPos8 = pos;
            var savedPos9 = pos;
            var result40 = parse_NewToken();
            if (result40 !== null) {
              var result41 = parse___();
              if (result41 !== null) {
                var result42 = parse_MemberExpression();
                if (result42 !== null) {
                  var result43 = parse___();
                  if (result43 !== null) {
                    var result44 = parse_Arguments();
                    if (result44 !== null) {
                      var result38 = [result40, result41, result42, result43, result44];
                    } else {
                      var result38 = null;
                      pos = savedPos9;
                    }
        ...
        if (result3 !== null) {
          ...
          if (result25 !== null) {
            ...
            if (result26 !== null) {
              var result27 = parse___();
              if (result27 !== null) {
                var result36 = parse_Expression();
                var result28 = result36 !== null ? result36 : '';
                if (result28 !== null) {
                  var result29 = parse___();
                  if (result29 !== null) {
                    if (input.substr(pos, 1) === ":") {
                    ...
                    if (result30 !== null) {
                      ...
                      if (result31 !== null) {
                        ...
                        var result32 = result35 !== null ? result35 : '';
                        if (result32 !== null) {
                          var result33 = parse___();
                          if (result33 !== null) {
                            if (input.substr(pos, 1) === "]") {
                            ...
                            if (result34 !== null) {
                              var result23 = [result25, result26, result27, result28, result29, result30, result31, result32, result33, result34];
                            } else {
                              var result23 = null;
                              pos = savedPos7;
                            }
          ...
          var result24 = result23 !== null
            ? (function(from, to) { 
                            ...
                            if (to) ast.arguments.push(to);
                            return ast
                    })(result23[3], result23[7])
            : null;
          if (result24 !== null) {
        ...
        var result2 = result1 !== null
          ? (function(base, accessors) {
                ...
                for (var i = 0; i < accessors.length; i++) {
                  if (accessors[i].type === 'FunctionCall') {
                      accessors[i].name.base = result;
                      result = accessors[i];
                  } else {
                      result = {
                        type: "PropertyAccess",
      ...
      function parse_CallExpression() {
        ...
        var savedPos10 = pos;
        var savedPos11 = pos;
        var result43 = parse_MemberExpression();
        if (result43 !== null) {
          var result44 = parse___();
          if (result44 !== null) {
            var result45 = parse_Arguments();
            if (result45 !== null) {
              var result41 = [result43, result44, result45];
            } else {
              var result41 = null;
              pos = savedPos11;
            }
        ...
        if (result3 !== null) {
          ...
          var result39 = parse___();
          if (result39 !== null) {
            var result40 = parse_Arguments();
            if (result40 !== null) {
              var result37 = [result39, result40];
            } else {
              var result37 = null;
              pos = savedPos9;
            }
      ...
      function parse_VariableExpression() {
        ...
        var savedPos0 = pos;
        var savedPos3 = pos;
        var result10 = parse_ShorthandVariableDeclarationList();
        var result11 = result10 !== null
          ? (function(declarations) { return declarations; })(result10)
          : null;
        if (result11 !== null) {
          var result9 = result11;
        } else {
        ...
        if (result9 !== null) {
          ...
          var result5 = result4 !== null
            ? (function(declarations) { return declarations; })(result4[2])
            : null;
          if (result5 !== null) {
            var result3 = result5;
          } else {
      ...
      function parse_VariableStatement() {
        ...
        var savedPos3 = pos;
        var savedPos4 = pos;
        var result13 = parse_ShorthandVariableDeclarationList();
        if (result13 !== null) {
        ...
        var result12 = result11 !== null
          ? (function(declarations) { return declarations; })(result11[0])
          : null;
        if (result12 !== null) {
      ...
      function parse_VariableStatementNoIn() {
        var cacheKey = 'VariableStatementNoIn@' + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
        ...
        var savedPos2 = pos;
        var result9 = parse_ShorthandVariableDeclarationListNoIn();
        if (result9 !== null) {
        ...
        if (result8 !== null) {
          ...
          var savedPos0 = pos;
          var savedPos1 = pos;
          var result4 = parse_VarToken();
          if (result4 !== null) {
            var result5 = parse___();
            if (result5 !== null) {
              var result6 = parse_VariableDeclarationListNoIn();
              if (result6 !== null) {
                var result7 = parse_EOS();
                if (result7 !== null) {
      ...
      function parse_ShorthandVariableDeclarationList() {
        var cacheKey = 'ShorthandVariableDeclarationList@' + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
        ...
        var savedPos0 = pos;
        var savedPos1 = pos;
        var result3 = parse_ShorthandVariableDeclaration();
        if (result3 !== null) {
          var result4 = [];
          var savedPos2 = pos;
          var result6 = parse___();
          if (result6 !== null) {
            ...
            if (result7 !== null) {
              var result8 = parse___();
              if (result8 !== null) {
                var result9 = parse_ShorthandVariableDeclaration();
                if (result9 !== null) {
                  var result5 = [result6, result7, result8, result9];
                } else {
                  var result5 = null;
      ...
      function parse_ShorthandVariableDeclarationListNoIn() {
        var cacheKey = 'ShorthandVariableDeclarationListNoIn@' + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
        ...
        var savedPos0 = pos;
        var savedPos1 = pos;
        var result3 = parse_ShorthandVariableDeclarationNoIn();
        if (result3 !== null) {
          var result4 = [];
          var savedPos2 = pos;
          var result6 = parse___();
          if (result6 !== null) {
            ...
            if (result7 !== null) {
              var result8 = parse___();
              if (result8 !== null) {
                var result9 = parse_ShorthandVariableDeclarationNoIn();
                if (result9 !== null) {
                  var result5 = [result6, result7, result8, result9];
                } else {
                  var result5 = null;
      ...
      function parse_ShorthandVariableDeclaration() {
        var cacheKey = 'ShorthandVariableDeclaration@' + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
        ...
        if (result3 !== null) {
          var result4 = parse___();
          if (result4 !== null) {
            var result5 = parse_ShorthandInitialiser();
            if (result5 !== null) {
              var result1 = [result3, result4, result5];
            } else {
              var result1 = null;
      ...
      function parse_ShorthandVariableDeclarationNoIn() {
        var cacheKey = 'ShorthandVariableDeclarationNoIn@' + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
        ...
        if (result3 !== null) {
          var result4 = parse___();
          if (result4 !== null) {
            var result5 = parse_ShorthandInitialiserNoIn();
            if (result5 !== null) {
              var result1 = [result3, result4, result5];
            } else {
              var result1 = null;
      ...
      function parse_ShorthandInitialiser() {
        var cacheKey = 'ShorthandInitialiser@' + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_ShorthandInitialiserNoIn() {
        var cacheKey = 'ShorthandInitialiserNoIn@' + pos;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = cachedResult.nextPos;
          return cachedResult.result;
      ...
      function parse_IfStatement() {
                ...
                if (result7 !== null) {
                  ...
                  if (result8 !== null) {
                    ...
                    if (result9 !== null) {
                      ...
                      var result12 = parse___();
                      if (result12 !== null) {
                        var result13 = parse_ElseToken();
                        if (result13 !== null) {
                          var result14 = parse___();
                          if (result14 !== null) {
                            var result15 = parse_Block();
                            if (result15 !== null) {
        ...
        var result2 = result1 !== null
          ? (function(initializer, condition, ifStatement, elseStatement) {
                var ifStatement = {
                  type:          "IfStatement",
                  condition:     condition,
                ...
                return initializer ? {
                      ...
                      "name": {
                          ...
                          "expression": {
                              ...
                              "name": null,
                              "params": [],
                              "elements": [initializer, ifStatement]
                          }
                      }
                 } : ifStatement; 
              })(result1[2], result1[4], result1[6], result1[7])
          : null;
        if (result2 !== null) {
          var result0 = result2;
        } else {
      ...
      function parse_ForStatement() {
        ...
        if (result3 !== null) {
          ...
          if (result4 !== null) {
            ...
            var savedPos5 = pos;
            var savedPos7 = pos;
            var result31 = parse_VariableExpression();
            var result32 = result31 !== null
              ? (function(expression) { return expression; })(result31)
              : null;
            if (result32 !== null) {
            ...
            if (result30 !== null) {
              ...
              var savedPos6 = pos;
              var result28 = parse_ExpressionNoIn();
              var result29 = result28 !== null
                ? (function(expression) { return expression; })(result28)
                : null;
              if (result29 !== null) {
            ...
            var result23 = result26 !== null ? result26 : '';
            if (result23 !== null) {
            ...
            var result22 = result21 !== null
              ? (function(expression) { return expression; })(result21[0])
              : null;
            if (result22 !== null) {
                ...
                if (result7 !== null) {
                  ...
                  if (result8 !== null) {
                    ...
                    var result13 = result12 !== null
                      ? (function(expression) { return expression; })(result12[2])
                      : null;
                    if (result13 !== null) {
      ...
      function parse_ForInStatement() {
        ...
        if (result3 !== null) {
          ...
          if (result4 !== null) {
            var savedPos4 = pos;
            var result19 = parse_VariableDeclarationNoIn();
            var result20 = result19 !== null
              ? (function(declaration) { return declaration; })(result19)
              : null;
            if (result20 !== null) {
            ...
            if (result18 !== null) {
              ...
              var savedPos2 = pos;
              var savedPos3 = pos;
              var result15 = parse_VarToken();
              if (result15 !== null) {
                var result16 = parse___();
                if (result16 !== null) {
                  var result17 = parse_VariableDeclaration();
                  if (result17 !== null) {
