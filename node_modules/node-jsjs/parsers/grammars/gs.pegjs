...
MemberExpression
  = base:(
    ...
    accessors:(
        __ "[" __ from:Expression? __ ":" __ to:Expression? __ "]" { 
                var ast = {
                    type: "FunctionCall",
                    name: {
                        type: "PropertyAccess",
...
VariableExpression
  = declarations:(
        declarations:ShorthandVariableDeclarationList { return declarations; }
       / VarToken __ declarations:VariableDeclarationList { return declarations; }
    ) {
        return {
...
VariableStatement
  = declarations:(
        declarations:ShorthandVariableDeclarationList EOS { return declarations; }
       / VarToken __ declarations:VariableDeclarationList EOS { return declarations; }
    ) {
        return {
            type:         "VariableStatement",
            declarations: declarations
...
VariableStatementNoIn
  = declarations:ShorthandVariableDeclarationListNoIn EOS
   / VarToken __ declarations:VariableDeclarationListNoIn EOS {
      return {
        type:         "VariableStatement",
        declarations: declarations
      };
...
ShorthandVariableDeclarationList
  = head:ShorthandVariableDeclaration tail:(__ "," __ ShorthandVariableDeclaration)* {
      var result = [head];
      for (var i = 0; i < tail.length; i++) {
        result.push(tail[i][3]);
      }
...
ShorthandVariableDeclarationListNoIn
  = head:ShorthandVariableDeclarationNoIn tail:(__ "," __ ShorthandVariableDeclarationNoIn)* {
      var result = [head];
      for (var i = 0; i < tail.length; i++) {
        result.push(tail[i][3]);
      }
...
ShorthandVariableDeclaration
  = name:Identifier __ value:ShorthandInitialiser {
      return {
...
ShorthandVariableDeclarationNoIn
  = name:Identifier __ value:ShorthandInitialiserNoIn {
      return {
        type:  "VariableDeclaration",
        name:  name,
        value: value !== "" ? value : null
...
IfStatement
  = IfToken __
    initializer:VariableStatement? __
    condition:Expression __
    ifStatement:Block
    elseStatement:(__ ElseToken __ Block)? {
      var ifStatement = {
        type:          "IfStatement",
        condition:     condition,
...
DoWhileStatement
  = DoToken __
    statement:Block __
    WhileToken __ condition:Expression __ EOS {
      return {
...
WhileStatement
  = WhileToken __ condition:Expression __ statement:Block {
      return {
        type: "WhileStatement",
        condition: condition,
        statement: statement
...
ForStatement
  = ForToken __
    initializer:(
        expression:(
            expression:VariableExpression { return expression; } 
          / expression:ExpressionNoIn { return expression; }
        )? __ ";" { return expression; }
    )? __
    test:Expression? __
    counter:(";" __ expression:Expression? __ { return expression; })?
    statement:Block
    {
      return {
        type:        "ForStatement",
...
ForInStatement
  = ForToken __
    iterator:(
      declaration:VariableDeclarationNoIn { return declaration; }
...
WithStatement
  = WithToken __ environment:Expression __ statement:Block {
      return {
        type:        "WithStatement",
...
SwitchStatement
  = SwitchToken __ expression:Expression __ clauses:CaseBlock {
      return {
...
Catch
  = CatchToken __ identifier:Identifier __ block:Block {
      return {
        type:       "Catch",
        identifier: identifier,
        block:      block
